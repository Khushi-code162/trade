...
function Footer() {
  ...
  <p style={{ margin: 0 }}>
    <span style={{ fontWeight: "bold" }}>Trademate</span>
  </p>
  <p style={{ margin: 0 }}>
    2024, Trademate Broking Ltd.<br />
    All rights reserved.
  </p>
</div>
      ...
      <p>
        Trademate Broking Ltd.: Member of NSE, BSE​ &​ MCX – CDSL/NSDL: Depository services through Zerodha Broking
        ...
        Phase, Bengaluru, India. For any complaints
